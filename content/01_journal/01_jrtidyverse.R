...
bike_orderlines_wrangled_tbl %>%
  write_xlsx("Desktop/ss23-bdsb-jamilarva/ds_data/01_bike_sales/02_wrangled_data/bike_orderlines.xlsx")

# 7.2 CSV ----
bike_orderlines_wrangled_tbl %>% 
  write_csv("Desktop/ss23-bdsb-jamilarva/ds_data/01_bike_sales/02_wrangled_data/bike_orderlines.csv")



# 7.3 RDS ----
bike_orderlines_wrangled_tbl %>% 
  write_rds("Desktop/ss23-bdsb-jamilarva/ds_data/01_bike_sales/02_wrangled_data/bike_orderlines.rds")
